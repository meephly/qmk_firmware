...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1]  = LAYOUT_ortho_4x12(
        KC_TAB,  KC_EXLM,       KC_AT,        KC_HASH,      KC_DLR,       KC_PERC, KC_CIRC,       KC_AMPR, KC_UP,   KC_NO,   KC_RPRN,       KC_BSLS,
        KC_ESC,  LGUI_T(KC_A),  LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_UNDS, LCTL(KC_LEFT), KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_RGHT), KC_NO,
