...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1]  = LAYOUT_ortho_4x12(
    ...
    KC_ESC,  KC_LGUI,    KC_LALT,    KC_LCTL,    KC_LSFT,    KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   KC_NO,
    KC_LSFT, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_DEL,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_UP,   KC_ENT,
    KC_LCTL, KC_LGUI,    KC_LALT,    KC_TRNS,    KC_TRNS,    KC_SPC,  KC_BSPC, MO(5),   KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [2]  = LAYOUT_ortho_4x12(
    KC_TAB,  KC_NO,  KC_NO,    KC_NO, KC_NO,   KC_NO, KC_NO,   KC_NO,    KC_LCBR, KC_RCBR, KC_NO,   KC_NO,
